    ...
    def flashcard
        ...
        if @type == "equity"
            ...
            if @flashcard_student != nil
                ...
                @student_hash = @flashcard_student.attributes
                # add the student's portrait url to the hash
                @student_hash[:portrait_url] = @flashcard_student.portrait.url(:flashcard)
            else
            ...
            if @quiz_student != nil
                # convert the student object to a hash
                @student_hash = @quiz_student.attributes
                # add the student's portrait url to the hash
                @student_hash[:portrait_url] = @quiz_student.portrait.url(:flashcard)
            else
                # otherwise send back an empty object
                @student_hash = {};
            end
